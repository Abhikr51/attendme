    ...
    return (
        ...
        >
            ...
            <AppLayout style={{ width: '100%', position: 'absolute', bottom: 20 ,paddingBottom : 10 }} >
                ...
                />
                <Spacer size={15} />
                <Button status='primary' onPress={loginUser} appearance={(spinner) ? "outline" : 'filled'}  accessoryLeft={(spinner) ? LoadingIndicator : null}>{spinner ? "logging in..." : "Proceed securely" } </Button>
