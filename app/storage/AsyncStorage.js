...
var LocalKeyStore = {
  ...
  getKey: async function (keyName, callback=()=>{}) {
    await AsyncStorage.getItem(keyName, function (error, value) { // callback: error, value
      if (error) {
  ...
  removeKey: function (keyName,callback = ()=>{}) { // callback: error
